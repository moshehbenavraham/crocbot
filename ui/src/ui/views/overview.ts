...
export function renderOverview(props: OverviewProps) {
  const snapshot = props.hello?.snapshot as
    | { uptimeMs?: number }
    | undefined;
  const policy = props.hello?.policy as
  ...
  const authHint = (() => {
      ...
      return html`
        <div class="muted" style="margin-top: 8px;">
          ...
          <div style="margin-top: 6px;">
            <span class="mono">crocbot dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">crocbot doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px;">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px;">
        ...
        <span class="mono">crocbot dashboard --no-open</span>, or update the token,
        then click Connect.
        <div style="margin-top: 6px;">
          <a
            class="session-link"
        ...
        <div class="form-grid" style="margin-top: 16px;">
          ...
          <label class="field">
            ...
            <input
              ...
              placeholder="CROCBOT_GATEWAY_TOKEN"
            />
          </label>
          <label class="field">
