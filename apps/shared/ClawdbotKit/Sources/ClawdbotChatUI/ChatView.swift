...
@MainActor
public struct crocbotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: crocbotChatViewModel
    ...
    public init(
        viewModel: crocbotChatViewModel,
    ...
    private var visibleMessages: [crocbotChatMessage] {
        let base: [crocbotChatMessage]
    ...
    private func mergeToolResults(in messages: [crocbotChatMessage]) -> [crocbotChatMessage] {
    ...
    private func isToolResultMessage(_ message: crocbotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: crocbotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: crocbotChatMessage) -> String {
