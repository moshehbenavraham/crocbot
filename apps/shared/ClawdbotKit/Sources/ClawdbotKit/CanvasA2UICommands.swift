...
public enum crocbotCanvasA2UICommand: String, Codable, Sendable {
...
public struct crocbotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct crocbotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
