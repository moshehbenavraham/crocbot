...
enum UIStrings {
    static let welcomeTitle = "Welcome to crocbot"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "crocbot.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: crocbotOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: crocbotChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g crocbot@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: crocbotChatViewModel(
