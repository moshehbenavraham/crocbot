...
# Defaults target the crocbot assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/crocbot/Resources/crocbot.icns"}
