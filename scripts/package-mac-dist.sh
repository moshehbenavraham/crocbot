...
# Output:
# - dist/crocbot.app
# - dist/crocbot-<version>.zip
# - dist/crocbot-<version>.dmg
...
ZIP="$ROOT_DIR/dist/crocbot-$VERSION.zip"
DMG="$ROOT_DIR/dist/crocbot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/crocbot-$VERSION.notary.zip"
