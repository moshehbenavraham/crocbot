...
const compiler = env.CROCBOT_TS_COMPILER === "tsc" ? "tsc" : "tsgo";
...
const shouldBuild = () => {
  if (env.CROCBOT_FORCE_BUILD === "1") return true;
...
const logRunner = (message) => {
  if (env.CROCBOT_RUNNER_LOG === "0") return;
  process.stderr.write(`[crocbot] ${message}\n`);
};
