...
show_usage() {
    cat << EOF
clawlog - crocbot Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View crocbot logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    crocbot logs flow through the macOS unified log (subsystem: com.clawdbot).
