...
export DISPLAY=:1
export HOME=/tmp/crocbot-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${CROCBOT_BROWSER_CDP_PORT:-9222}"
VNC_PORT="${CROCBOT_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${CROCBOT_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${CROCBOT_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${CROCBOT_BROWSER_HEADLESS:-0}"
