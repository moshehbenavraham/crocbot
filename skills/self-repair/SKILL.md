...
1. **Source Code:** `/home/aiwithapex/projects/crocbot` (where repairs/exploration happen)
2. **Identity Workspace:** `/home/aiwithapex/croc` (where research, reports, and persistent documentation are stored)
...
bash pty:true workdir:/home/aiwithapex/projects/crocbot background:true command:"/home/aiwithapex/.local/bin/claude -p 'Use maximum thinking budget for this prompt and make sure you output a detailed summary end of response. You have permission to write files directly to my identity workspace at /home/aiwithapex/croc/ for reporting or research purposes. Instructions: <instructions>' --dangerously-skip-permissions"
```
...
- **Targeted Scope:** Always set the `workdir` to `/home/aiwithapex/projects/crocbot`.
