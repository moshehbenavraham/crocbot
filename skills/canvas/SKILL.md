...
Display HTML content on connected crocbot nodes (Mac app, iOS, Android).
...
```
http://<tailscale-hostname>:18793/__crocbot__/canvas/<file>.html
```
...
- **loopback**: `http://127.0.0.1:18793/__crocbot__/canvas/<file>.html`
- **lan/tailnet/auto**: `http://<hostname>:18793/__crocbot__/canvas/<file>.html`
...
**Example:**
```
canvas action:present node:mac-63599bc4-b54d-4392-9048-b97abd58343a target:http://peters-mac-studio-1.sheep-coho.ts.net:18793/__crocbot__/canvas/snake.html
```
...
Node is offline. Use `crocbot nodes list` to find online nodes.
