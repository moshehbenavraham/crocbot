...
read_when:
  - Setting up Zalo Personal for crocbot
...
- Install via CLI: `crocbot plugins install @crocbot/zalouser`
- Or from a source checkout: `crocbot plugins install ./extensions/zalouser`
...
2) Login (QR, on the Gateway machine):
   - `crocbot channels login --channel zalouser`
...
Approve via:
- `crocbot pairing list zalouser`
- `crocbot pairing approve zalouser <code>`
...
- On startup, crocbot resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `crocbot channels logout --channel zalouser && crocbot channels login --channel zalouser`
