...
- Install via CLI: `crocbot plugins install @crocbot/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `crocbot plugins install ./extensions/zalo`
   - From npm (if published): `crocbot plugins install @crocbot/zalo`
...
- Approve via:
  - `crocbot pairing list zalo`
  - `crocbot pairing approve zalo <CODE>`
...
- Example: `crocbot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `crocbot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `crocbot logs --follow`
