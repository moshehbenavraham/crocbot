...
Status: the native chat UI talks directly to the Gateway WebSocket.

## What it is
- A chat UI for the gateway (no embedded browser and no local static server).
- Uses the same sessions and routing rules as Telegram.
