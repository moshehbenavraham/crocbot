...
```bash
crocbot nodes invoke --node <id|name|ip> --command <command> --params <json>
crocbot nodes run --node <id|name|ip> <command...>
crocbot nodes run --raw "git status"
crocbot nodes run --agent main --node <id|name|ip> --raw "git status"
```
