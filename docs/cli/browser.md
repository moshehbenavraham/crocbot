---
summary: "CLI reference for `crocbot browser` (profiles, tabs, actions, extension relay)"
read_when:
  - You use `crocbot browser` and want examples for common tasks
...
Manage crocbot’s browser control server and run browser actions (tabs, snapshots, screenshots, navigation, clicks, typing).
