---
summary: "Default crocbot agent instructions and skills roster for the personal assistant setup"
read_when:
  - Starting a new crocbot agent session
  - Enabling or auditing default skills
---
# AGENTS.md — crocbot Personal Assistant (default)
...
- macOS app manages permissions (screen recording, notifications, microphone) and exposes the `crocbot` CLI via its bundled binary.
