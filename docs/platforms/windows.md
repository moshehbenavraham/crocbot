...
read_when:
  - Installing crocbot on Windows
  - Looking for Windows companion app status
---
# Windows (WSL2)

crocbot on Windows is recommended **via WSL2** (Ubuntu recommended). The
