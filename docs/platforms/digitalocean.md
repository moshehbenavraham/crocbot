---
summary: "crocbot on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up crocbot on DigitalOcean
  - Looking for cheap VPS hosting for crocbot
---

# crocbot on DigitalOcean

## Goal

Run a persistent crocbot Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
# Check service
systemctl --user status crocbot-gateway.service

# View logs
journalctl --user -u crocbot-gateway.service -f
```
...
journalctl -u crocbot --no-pager -n 50
```
