...
The macOS app surfaces crocbot skills via the gateway; it does not parse skills locally.
...
## Env/API keys
- The app stores keys in `~/.clawdbot/crocbot.json` under `skills.entries.<skillKey>`.
