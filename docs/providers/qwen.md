---
summary: "Use Qwen OAuth (free tier) in crocbot"
read_when:
  - You want to use Qwen with crocbot
...
```bash
crocbot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, crocbot will sync credentials
