...
You can point crocbot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or crocbot
...
- [Anthropic provider](/providers/anthropic) - Native crocbot integration with Claude setup-token or API keys
