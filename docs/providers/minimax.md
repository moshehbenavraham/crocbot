---
summary: "Use MiniMax M2.1 in crocbot"
read_when:
  - You want MiniMax models in crocbot
...
Configure manually via `crocbot.json`:
...
- Use `crocbot models list` and `crocbot models set minimax/MiniMax-M2.1` to switch.
...
- Running `crocbot configure` and selecting **MiniMax M2.1**, or
