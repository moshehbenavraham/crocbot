...
- CLI helpers: `crocbot onboard`, `crocbot models list`, `crocbot models set <provider/model>`.

## Built-in providers (pi-ai catalog)

crocbot ships with the pi‑ai catalog. These providers require **no**
...
- CLI: `crocbot onboard --auth-choice openai-api-key`
...
- CLI: `crocbot onboard --auth-choice token` (paste setup-token) or `crocbot models auth paste-token --provider anthropic`
...
- CLI: `crocbot onboard --auth-choice openai-codex` or `crocbot models auth login --provider openai-codex`
...
- CLI: `crocbot onboard --auth-choice opencode-zen`
...
- CLI: `crocbot onboard --auth-choice gemini-api-key`
...
- CLI: `crocbot onboard --auth-choice zai-api-key`
...
- CLI: `crocbot onboard --auth-choice ai-gateway-api-key`
...
crocbot models auth login --provider qwen-portal --set-default
```
...
- CLI: `crocbot onboard --auth-choice synthetic-api-key`
...
- For custom providers, `reasoning`, `input`, `cost`, `contextWindow`, and `maxTokens` are optional.
  When omitted, crocbot defaults to:
  - `reasoning: false`
  - `input: ["text"]`
  - `cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 }`
  - `contextWindow: 200000`
...
```bash
crocbot onboard --auth-choice opencode-zen
crocbot models set opencode/claude-opus-4-5
crocbot models list
```
