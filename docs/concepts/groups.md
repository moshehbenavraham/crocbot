...
crocbot treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)
crocbot “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, crocbot can see that group and respond there.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@clawd", "crocbot", "\\+15555550123"],
          historyLimit: 50
        }
      }
    ]
