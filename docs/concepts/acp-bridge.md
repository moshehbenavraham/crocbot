---
summary: "ACP bridge internals — execution model, session mapping, and prompt translation"
read_when:
  - Understanding ACP bridge architecture
  - Debugging session mapping between ACP and Gateway
---
