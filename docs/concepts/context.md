...
read_when:
  - You want to understand what “context” means in crocbot
  - You are debugging why the model “knows” something (or forgot it)
  - You want to reduce context overhead (/context, /status, /compact)
---
# Context

“Context” is **everything crocbot sends to the model for a run**. It is bounded by the model’s **context window** (token limit).

Beginner mental model:
- **System prompt** (crocbot-built): rules, tools, skills list, time/runtime, and injected workspace files.
...
## How crocbot builds the system prompt

The system prompt is **crocbot-owned** and rebuilt each run. It includes:
...
By default, crocbot injects a fixed set of workspace files (if present):
- `AGENTS.md`
- `SOUL.md`
- `TOOLS.md`
- `IDENTITY.md`
