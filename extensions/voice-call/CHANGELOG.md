...
### Changes
- Version alignment with core crocbot release numbers.
...
### Highlights
- First public release of the @crocbot/voice-call plugin.
...
- CLI: `crocbot voicecall` commands (call/start/continue/speak/end/status/tail/expose).
