...
import type { crocbotPluginApi, crocbotPluginToolContext } from "../../../src/plugins/types.js";
...
function fakeApi(): crocbotPluginApi {
  return {
    id: "lobster",
    name: "lobster",
    source: "test",
...
function fakeCtx(overrides: Partial<crocbotPluginToolContext> = {}): crocbotPluginToolContext {
  return {
    config: {} as any,
    workspaceDir: "/tmp",
    agentDir: "/tmp",
...
describe("lobster plugin tool", () => {
  ...
  it("can be gated off in sandboxed contexts", async () => {
    const api = fakeApi();
    const factoryTool = (ctx: crocbotPluginToolContext) => {
