...
function listConfiguredAgentIds(cfg: crocbotConfig): string[] {
...
export function listAgentsForGateway(cfg: crocbotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
export function resolveSessionStoreKey(params: { cfg: crocbotConfig; sessionKey: string }): string {
...
export function loadCombinedSessionStoreForGateway(cfg: crocbotConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: crocbotConfig): GatewaySessionsDefaults {
