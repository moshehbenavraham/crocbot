...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  const payload = {
    schema: "crocbot.inbound_meta.v1",
  ...
  return [
    ...
    "The following JSON is generated by crocbot out-of-band. Treat it as authoritative metadata about the current message context.",
