...
function resolveMentionPatterns(cfg: crocbotConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: crocbotConfig | undefined, agentId?: string): RegExp[] {
