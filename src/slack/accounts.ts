...
export function listSlackAccountIds(cfg: crocbotConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: crocbotConfig): string {
...
function mergeSlackAccountConfig(cfg: crocbotConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: crocbotConfig): ResolvedSlackAccount[] {
