...
export function listBindings(cfg: crocbotConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: crocbotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: crocbotConfig) {
