...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof crocbotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: crocbotConfig; env: NodeJS.ProcessEnv }): {
  cfg: crocbotConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
