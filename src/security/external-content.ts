 ...
 * Prevents injection attacks using visually similar characters.
 */
...
/** Fold Unicode homoglyphs used in marker text to their ASCII equivalents. */
...
/**
 * Sanitize content that might contain spoofed boundary markers.
 * Folds Unicode homoglyphs to ASCII, then replaces any markers found.
 */
