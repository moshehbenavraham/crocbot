...
export function resolveTtsConfig(cfg: crocbotConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.CROCBOT_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: crocbotConfig): string | undefined {
