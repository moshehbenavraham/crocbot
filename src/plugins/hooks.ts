...
export function createHookRunner(registry: PluginRegistry, options: HookRunnerOptions = {}) {
  ...
  function runToolResultPersist(
    ...
    for (const hook of hooks) {
      try {
        // oxlint-disable-next-line typescript/no-explicit-any -- plugin hook handler signature varies by hook type; safe cast for invocation
        ...
        // oxlint-disable-next-line typescript/no-explicit-any -- checking for accidental Promise return; thenable detection requires any
