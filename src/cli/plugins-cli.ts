...
function applySlotSelectionForPlugin(
  ...
  pluginId: string,
): { config: crocbotConfig; warnings: string[] } {
...
export function registerPluginsCli(program: Command) {
  const plugins = program
    .command("plugins")
    .description("Manage crocbot plugins/extensions")
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/plugins", "docs.github.com/moshehbenavraham/crocbot/cli/plugins")}\n`,
    );
  ...
  plugins
    ...
    .action(() => {
      ...
      const docs = formatDocsLink("/plugin", "docs.github.com/moshehbenavraham/crocbot/plugin");
      lines.push("");
