...
function resolveAnthropicDefaultAuthMode(cfg: crocbotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: crocbotConfig): crocbotConfig {
...
export function applyTalkApiKey(config: crocbotConfig): crocbotConfig {
...
export function applyModelDefaults(cfg: crocbotConfig): crocbotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: crocbotConfig): crocbotConfig {
...
export function applyLoggingDefaults(cfg: crocbotConfig): crocbotConfig {
...
export function applyContextPruningDefaults(cfg: crocbotConfig): crocbotConfig {
...
export function applyCompactionDefaults(cfg: crocbotConfig): crocbotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
