...
function resolveAvatarSource(cfg: crocbotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: crocbotConfig, agentId: string): AgentAvatarResolution {
