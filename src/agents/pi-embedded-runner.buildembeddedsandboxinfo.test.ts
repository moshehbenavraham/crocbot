...
const _ensureModels = (cfg: crocbotConfig, agentDir: string) =>
  ensurecrocbotModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/crocbot-sandbox",
      agentWorkspaceDir: "/tmp/crocbot-workspace",
      ...
      browser: {
        ...
        containerName: "crocbot-sbx-browser-test",
      },
