...
import type { crocbotConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: crocbotConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: crocbotConfig | undefined, pathStr: string): boolean {
...
export function resolveSkillConfig(
  config: crocbotConfig | undefined,
  skillKey: string,
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "crocbot-bundled";
}

export function resolveBundledAllowlist(config?: crocbotConfig): string[] | undefined {
