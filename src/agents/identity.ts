import type { crocbotConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveResponsePrefix(cfg: crocbotConfig, agentId: string): string | undefined {
