...
function resolveMainSessionKeyForSandbox(params: { cfg?: crocbotConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: crocbotConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`crocbot sandbox explain --session ${runtime.sessionKey}`)}`,
  );
