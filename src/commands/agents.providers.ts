...
function resolveDefaultAccountId(cfg: crocbotConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: crocbotConfig): boolean {
...
export function summarizeBindings(cfg: crocbotConfig, bindings: AgentBinding[]): string[] {
