...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "crocbot-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<crocbotConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<crocbotConfig["telegram"]>>,
