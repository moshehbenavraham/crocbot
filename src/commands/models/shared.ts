...
export async function updateConfig(
  mutator: (cfg: crocbotConfig) => crocbotConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: crocbotConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: crocbotConfig): Set<string> {
