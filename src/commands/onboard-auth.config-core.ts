...
export function applyZaiConfig(cfg: crocbotConfig): crocbotConfig {
...
export function applyOpenrouterProviderConfig(cfg: crocbotConfig): crocbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: crocbotConfig): crocbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: crocbotConfig): crocbotConfig {
...
export function applyOpenrouterConfig(cfg: crocbotConfig): crocbotConfig {
...
export function applyMoonshotProviderConfig(cfg: crocbotConfig): crocbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: crocbotConfig): crocbotConfig {
...
export function applyKimiCodeProviderConfig(cfg: crocbotConfig): crocbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: crocbotConfig): crocbotConfig {
...
export function applySyntheticProviderConfig(cfg: crocbotConfig): crocbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: crocbotConfig): crocbotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: crocbotConfig): crocbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: crocbotConfig): crocbotConfig {
